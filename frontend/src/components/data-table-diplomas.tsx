        ...
        },
        {
          ...
          cell: ({ row }) => (
            <div
              ...
              title={row.getValue("institution")}
            >
      ...
      <div className="w-full">
        <div className="flex items-center justify-between py-4">
          ...
          <div className="gap-2 flex items-center">
            ...
            variant="link"
              onClick={() =>
                downloadCsv(`diplomas${Date.now()}.csv`, convertToCsv(data))
              }
            >
              Export to CSV
            </Button>
            ...
            <Button variant="outline" size="sm">
              ...
              <span>
                <Link to="/diplomas/create">Add Diploma</Link>
              </span>
            </Button>
            {Object.keys(rowSelection).length > 1 ? (
              <Button variant="outline" size="sm">
                ...
                <span>
                  <Link
                    to={`/diplomas/batchUpdateStatus/${encodeURIComponent(
